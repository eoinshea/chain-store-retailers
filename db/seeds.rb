user1 = User.create!(email: 'dublin@example.com', password: 'dublin123', password_confirmation: 'dublin123', agent_id: "11111111" ,approved: true )
user2 = User.create!(email: 'galway@example.com', password: 'galway123', password_confirmation: 'galway123', agent_id: "22222222" ,approved: true )
user3 = User.create!(email: 'cork@example.com', password: 'cork123', password_confirmation: 'cork123', agent_id: "33333333"  )
user4 = User.create!(email: 'athlone@example.com', password: 'athlone123', password_confirmation: 'athlone123', agent_id: "44444444"  )
user5 = User.create!(email: 'tralee@example.com', password: 'tralee123', password_confirmation: 'tralee123', agent_id: "55555555"  )
...
#         sale.lotto         		= row[3]   
#         sale.lotto_plus    		= row[4]
#         sale.euro_millions      	= row[5]  
#         sale.euro_millions_plus         = row[6]                       
#         sale.scratchcard     		= row[7]   
#         sale.save      
# end